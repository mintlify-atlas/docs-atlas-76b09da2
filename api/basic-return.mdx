---
title: "BasicReturn – Pydantic Base Return Model Reference"
sidebarTitle: "BasicReturn"
description: "API reference for BasicReturn, a Pydantic BaseModel with ok and error fields that signal success or failure and capture raised exceptions."
---
